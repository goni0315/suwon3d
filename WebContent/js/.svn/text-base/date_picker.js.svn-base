...
function datePicker(e, elm) {
	...
	if(arguments[0]){
		...
		if(eventX>document.body.offsetWidth-146-40) eventX = document.body.offsetWidth-146-40;
		if(eventY>document.body.offsetHeight-123-40) eventY = document.body.offsetHeight-123-40;
		var calDivObj = document.createElement("div");
		calDivObj.setAttribute("id","currentDiv");
		calDivObj.style.width = '146px';
		calDivObj.style.height = '123px';
