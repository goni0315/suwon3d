...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
		...
		<div id="pop_footer">
		    <div class="btn_area">
	            <a href="javascript:fn_imageUp();"><img src="${ctx}/se2/img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
	            <a href="#"><img src="${ctx}/se2/img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
	        </div>
    	</div>
        <!-- //content -->
    ...
    <div id="pop_container" class="pop_container" style="display:none;">
		...
		<div id="pop_footer">
	    <div class="btn_area">
            <a href="javascript:fn_imageUp5();"><img src="${ctx}/se2/img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="#"><img src="${ctx}/se2/img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
        <!-- //content -->
