...
function toggleBtn(objNm,toggleNm) {
	if(objNm != '' || toggleNm != ''){
		...
		case 'playMode':
			if(objNm == 'play'){
				if(document.getElementById("flyView").src.indexOf('on.gif') == -1){
					doExecute();
					document.getElementById("play").src = "${ctx}/images/navi11_on.gif";
					document.getElementById("pause").src = "${ctx}/images/navi12_off.gif";
					document.getElementById("stop").src = "${ctx}/images/navi13_off.gif";
	...
	<div style="width: 436px;">
		<div style="float: left">
			<table border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td>
						<a href="#" class="roll" onclick="doInputPoint()">
							<img src="${ctx}/images/navi01_off.gif" alt="경로설정">
							<img src="${ctx}/images/navi01_on.gif" class="over" alt="경로설정">
						</a>
					</td>
				</tr>
				<tr>
					<td>
						<a href="#" class="roll" onclick="doSave()">
							<img src="${ctx}/images/navi02_off.gif" alt="경로저장">
							<img src="${ctx}/images/navi02_on.gif" class="over" alt="경로저장">
						</a>
					</td>
				</tr>
				<tr>
					<td>
						<a href="#" class="roll" onclick="doOpen()">
							<img src="${ctx}/images/navi03_off.gif" alt="불러오기">
							<img src="${ctx}/images/navi03_on.gif" class="over" alt="불러오기">
						</a>
					</td>
				</tr>
				<tr>
					<td>
						<a href="#" class="roll" onclick="doInit()">
							<img src="${ctx}/images/navi04_off.gif" alt="경로삭제">
							<img src="${ctx}/images/navi04_on.gif" class="over" alt="경로삭제">
						</a>
					</td>
				</tr>
			</table>
		...
		<div style="float: left">
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td>
						<a href="#" name="naviView" onclick="toggleBtn('fly','naviView');doExecuteFly()">
							<img id="flyView" src="${ctx}/images/navi05_on.gif" alt="">
						</a>
					</td>
				</tr>
				<tr>
					<td>
						<a href="#" name="naviView" onclick="toggleBtn('car','naviView');doExecute()">
							<img id="carView" src="${ctx}/images/navi06_off.gif" alt="">
						</a>
					</td>
				</tr>
			</table>
		...
		<div style="float: left">
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="91" style="background: url(${ctx}/images/navi_bg01.gif) no-repeat;">
	                    <ul style=" margin-left:5px; margin-top:5px;">
		                    <li style="float:left;"><a href="#" onclick="naviSpeed('down')"><img src="${ctx}/images/set26_2.gif"></a></li>
		                    <li style="float:left; width:32px; margin-top:3px;"><input type="text" name="set_speed" id="set_speed" value="5" style="text-align:center;border:solid 1px; width:30px;" readonly></li>
		                    <li><a href="#" onclick="naviSpeed('up')"><img src="${ctx}/images/set26_1.gif"></a></li>
	                    </ul>
					</td>
					<td width="91" style="background: url(${ctx}/images/navi_bg03.gif) no-repeat;" align="center">
						<ul>
							<li>
								<a href="#" onclick="doRecordStart()">
									<img id="recIcon" src="${ctx}/images/navi_bg03.gif">
								</a>
							</li>
						</ul>
					</td>
					<td>
						<!-- 재생 -->
						<a href="#" name="playMode" onclick="toggleBtn('play','playMode');">
							<img id="play" src="${ctx}/images/navi11_off.gif" alt="">
						</a>
					</td>
					<td>
						<!-- 일시정지 -->
						<a href="#" name="playMode" onclick="toggleBtn('pause','playMode');doPause()">
							<img id="pause" src="${ctx}/images/navi12_off.gif" alt="">
						</a>
					</td>
					<td>
						<!-- 정지 -->
						<a href="#" name="playMode" onclick="toggleBtn('stop','playMode');doStop()">
							<img id="stop" src="${ctx}/images/navi13_off.gif" alt="">
						</a>
					</td>
				</tr>
			</table>
		...
		<div style="float: left">
			<table border="0" cellpadding="0" cellspacing="0" style="float: left">
				<tr>
					<!-- 전 -->
					<td>
						<a href="#" name="viewMode" onclick="toggleBtn('F','viewMode');doSetDirect(0)">
							<img id="front" src="${ctx}/images/navi07_on.gif" alt="">
						</a>
					</td>
					<!-- 후 -->
					<td>
						<a href="#" name="viewMode" onclick="toggleBtn('B','viewMode');doSetDirect(180)">
							<img id="back" src="${ctx}/images/navi08_off.gif" alt="">
						</a>
					</td>
				</tr>
				<tr>
					<!-- 좌 -->
					<td>
						<a href="#" name="viewMode" onclick="toggleBtn('L','viewMode');doSetDirect(-90)">
							<img id="left" src="${ctx}/images/navi09_off.gif" alt="">
						</a>
					</td>
					<!-- 우 -->
					<td>
						<a href="#" name="viewMode" onclick="toggleBtn('R','viewMode');doSetDirect(90)">
							<img id="right" src="${ctx}/images/navi10_off.gif" alt="">
						</a>
					</td>
				</tr>
			</table>
		...
		<div style="float: left">
			<table width="207" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td height="31" colspan="8" style="background: url(${ctx}/images/navi_bg02.gif)">
						<input type="text" name="input_set_height" id="input_set_height" align="absmiddle" value="300" style="width: 50px; margin: 2px 0 0 50px">
					</td>
				</tr>
				<tr>
					<!-- 정보 -->
				<%-- 
				  ...
				  <td><a href="#" name="toolMenu" onclick="toggleBtn('na_tool1','toolMenu');" title="정보보기">
					...
					<!-- 캡처 -->
					<td>
						<a href="#" name="toolMenu" onclick="toggleBtn('na_tool2','toolMenu');" title="화면저장">
							<img id="na_tool2" src="${ctx}/images/na_tool02_off.gif" alt="">
						</a>
					</td>
					<!-- 인쇄 -->
					<td>
						<a href="#" name="toolMenu" onclick="toggleBtn('na_tool3','toolMenu');" title="화면출력">
							<img id="na_tool3" src="${ctx}/images/na_tool03_off.gif" alt="">
						</a>
					</td>
					<!-- 이동 -->
					<td>
						<a href="#" name="toolMenu" onclick="toggleBtn('na_tool4','toolMenu');" title="손이동">
							<img id="na_tool4" src="${ctx}/images/na_tool04_off.gif" alt="">
						</a>
					</td>
					<!-- 전체화면 -->
					<td>
						<a href="#" name="toolMenu" onclick="toggleBtn('na_tool5','toolMenu');" title="전체화면">
							<img id="na_tool5" src="${ctx}/images/na_tool05_off.gif" alt="">
						</a>
					</td>
					<!-- 새로고침 -->
					<td>
						<a href="#" name="toolMenu" onclick="toggleBtn('na_tool6','toolMenu');" title="초기화">
