...
<title>LPG배관 정보조회</title>
<link href="${ctx}/css/common.css" rel="stylesheet" type="text/css" />
</head>
<body>
<!--LPG배관 정보조회-->
	<div style="width: 460px; height: 200px; border: solid 1px #2c3445;">
		<div style="background: #2c3445; margin: 2px;">
			<p style="float: right;">
				<img src="${ctx}/images/pop_close.gif" />
			</p>
		  <p class="f_whit_am">LPG배관 정보 조회</p>
		</div>
		<div class="bbsCont">
		
			<table width="460" border="1" class="wps_100">
				...
				<c:if test="${not empty LpgPipeInfoList}">
				<c:forEach var="sms" items="${LpgPipeInfoList}">
				<tr>
				...
				<c:if test="${ empty LpgPipeInfoList}">
				<tr>
					<th class="bbsFrom">관리번호</th>
					<td>8080785412</td>
					<th class="bbsFrom">설치일자</th>
