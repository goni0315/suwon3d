...
<!--광역상수관 정보조회-->
	<div style="width: 350px; height: 200px; border: solid 1px #2c3445;">
		<div style="background: #2c3445; margin: 2px;">
		  ...
		  <p class="f_whit_am">광역상수관 정보 조회</p>
		</div>
		<div class="bbsCont">
			...
			<table width="350" border="1" class="wps_100">
				...
				<c:if test="${not empty WidePipeInfoList}">
				<c:forEach var="sms" items="${WidePipeInfoList}">
				<tr>
				...
				<c:if test="${ empty WidePipeInfoList}">
				<tr>
					<th class="bbsFrom">관리번호</th>
					<td>8080785412</td>
					<th class="bbsFrom">설치일자</th>
